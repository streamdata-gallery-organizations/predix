...
x-complete: 0
info:
  title: Predix BlockChain Delete Users
  description: Deletes the user and the user mapping with oauth user. User can be
    deleted only after user has been enrolled.
  version: 1.0.0
