...
x-complete: 0
info:
  title: Predix Data Services Query for Current Value
  version: 1.0.0
  description: "This API helps to query for timeseries for the latest values for the
    given tags. The POST API also provides a way to specify a time window or filter
    options and retrieves the latest value that satisfies it.Request JSON{\n\t\"tags\":
