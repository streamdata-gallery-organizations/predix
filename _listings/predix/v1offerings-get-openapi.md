...
x-complete: 0
info:
  title: Predix Nurego Get Offerings
  description: You can retrieve the available Offerings for a specific Segment and/or
    Distribution channel, by using the following attributes in your method call.
  contact:
